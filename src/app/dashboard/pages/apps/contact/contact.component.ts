...
import { ContactContentDialogComponent } from "./contact-content-dialog/contact-content-dialog.component";
...
export class ContactComponent implements OnInit {
  ...
  openDialog(action, obj) {
    obj.action = action;
    const dialogRef = this.dialog.open(ContactContentDialogComponent, {
      data: obj
    });
